    ...
    <div class="bg-utama">
        ...
        <div class="container py-3 px-5 pt-5">
            <div class="centered-text d-flex justify-content-center "   >
                <p class="title display-5 w-75 text-center">Konsultasi</p>
            </div>
        </div>
     ...
     <div class="container-xxl    ">
      ...
      <img src="{{ asset('asset/image/zakat/konsultasi-zakat.png') }}" class="w-100 mt-5" alt="">

     </div>
     <div class="container display-5">
      <div class="text p-4">
         <p >
            Butuh panduan zakat, infaq, sedekah? Hubungi kami. Bantu sesama dengan bijak. Konsultasi gratis! #BerkahMemberi.
         </p>
      </div>
         ...
         <div class="col md-6  w-100">
               <div class="container w-100 p-3  d-flex align-items-center justify-content-center ">
                  <form  class=" w-100">
                    ...
                    <div class="mb-4">
                        <label for="nama" class="form-label">Perihal</label> <br>
                        <textarea name="" id="custom-input" class="w-100" placeholder="comment"></textarea>
                    </div>
                    <div class="form-check pt-2">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault"> I am human</label>
                      </div>
                  </form>
              </div>
              <div class="button">
               <form class="form-btn-container d-flex justify-content-start p-3">
                  <a href="" class="btn text-light align-self-start" id="donate-button"> kirim</a>
              </form>
              </div>
         </div>
      </div>
