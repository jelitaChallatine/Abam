                     ...
                     <div class="content d-flex overflow-auto w-100 gap-4 mb-5">
                        ...
                        <div class="konten w-100">
                           <div class="mb-2 d-flex flex-column align-items-center px-1"style="border: 1px solid rgba(0, 0, 0, 0.084); padding: 10%;">
                            <div class="container">
                                <img src="asset/img-update/photo1.png" class=" img_posision" alt="" />
                            </div>
                        ...
                        <div class="konten w-100">
                           <div class="mb-2 d-flex flex-column align-items-center px-1"style="border: 1px solid rgba(0, 0, 0, 0.084); padding: 10%;">
                            <div class="container">
                                <img src="asset/img crausel/img-detail/Rectangle 27.png" class=" img_posision" alt="" />
                            </div>
                              <div class="info-posision">
      ...
      <div class="lay5 h-100">
         <div class="container-xxl lay5_posision d-flex ">
            <div
               ...
               <div class="col">
                  <ul class="List_1">
                     <span class="title_List">Menu</span>
